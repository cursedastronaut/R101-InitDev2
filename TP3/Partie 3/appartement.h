...
public:
    //---------------  constructeurs 
    Appartement(); /// appartement vide au d�part
    ...
    void afficher()const;  // affiche l'adressee et les pi�ces de l'appartement
    ...
    Piece retraitPiece(int i) ;// retire la piece dont l'indice est fourni en parametre. Si incorrect : d�clenche exception out_of_range
    int recherche(const string&);
    int recherchePremier(const string&);
  };
#endif
